...
def parse_options1(is_train=True):
    parser = argparse.ArgumentParser()
    parser.add_argument(
        '-opt1', type=str, required=True, help='Path to option YAML file.')
    parser.add_argument(
        '-opt2', type=str, required=True, help='Path to option YAML file.')
    ...
    opt = parse(args.opt1, is_train=is_train)
...
def parse_options2(is_train=True):
    parser = argparse.ArgumentParser()
    parser.add_argument(
        '-opt1', type=str, required=True, help='Path to option YAML file.')
    parser.add_argument(
    ...
    args = parser.parse_args()
    opt = parse(args.opt2, is_train=is_train)
