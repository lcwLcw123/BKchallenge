...
if __name__ == "__main__":
    ...
    dataset_tr_src = {"name": "Bokeh-train_src",
                 "im_dir": "/home2/chenzigeng/Bokeh_v7/train",
                 "gt_dir": "/home2/chenzigeng/Bokeh_v7/train",
                 "im_ext": ".src.jpg",
                 "gt_ext": ".alpha.png",
                 "cache_dir":"/Checkpoint/chenzigeng/dehaze/Bokeh_cache_train_src"}
    dataset_tr_tgt = {"name": "Bokeh-train_tgt",
                "im_dir": "/home2/chenzigeng/Bokeh_v7/train",
                "gt_dir": "/home2/chenzigeng/Bokeh_v7/train",
                "im_ext": ".tgt.jpg",
                "gt_ext": ".alpha.png",
                "cache_dir":"/Checkpoint/chenzigeng/dehaze/Bokeh_cache_train_tgt"}

    dataset_vd_src = {"name": "Bokeh-vd_src",
                 "im_dir": "/home2/chenzigeng/Bokeh_v7/train_val",
                 "gt_dir": "/home2/chenzigeng/Bokeh_v7/train_val",
                 "im_ext": ".src.jpg",
                 "gt_ext": ".alpha.png",
                 "cache_dir":"/Checkpoint/chenzigeng/dehaze/Bokeh_cache_vd_src"}
    
    dataset_vd_tgt = {"name": "Bokeh-vd_tgt",
                "im_dir": "/home2/chenzigeng/Bokeh_v7/train_val",
                "gt_dir": "/home2/chenzigeng/Bokeh_v7/train_val",
                "im_ext": ".tgt.jpg",
                "gt_ext": ".alpha.png",
                "cache_dir":"/Checkpoint/chenzigeng/dehaze/Bokeh_cache_vd_tgt"}
    ...
    train_datasets = [dataset_tr_src,dataset_tr_tgt] ## users can create mutiple dictionary for setting a list of datasets as training set
    # train_datasets = [dataset_vd_tgt]
    ...
    valid_datasets = [dataset_vd_tgt,dataset_vd_src] # dataset_vd, dataset_te1, dataset_te2, dataset_te3, dataset_te4] # and hypar["mode"] = "valid" for inference,
    ...
    if hypar["mode"] == "train":
        ...
        hypar["model_path"] ="../saved_models/Bokeh_fulldata_newtrain" ## model weights saving (or restoring) path
        hypar["restore_model"] = "gpu_itr_14000_traLoss_0.1343_traTarLoss_0.0188_valLoss_0.2312_valTarLoss_0.0318_maxF1_0.9911_0.9911_mae_0.0048_0.0049_time_0.041323.pth" ## name of the segmentation model weights .pth for resume training process from last stop or for the inferencing
        hypar["start_ite"] = 14000 ## start iteration for the training, can be changed to match the restored training process
    ...
    hypar["early_stop"] = 2000 ## stop the training when no improvement in the past 20 validation periods, smaller numbers can be used here e.g., 5 or 10.
